...
export default function NavBar({ settings }: NavBarProps) {
  ...
  return (
    <nav className="md-:py-6 px-4 py-4 md:px-6 bg-white z-50" aria-label="Main">
      <div className="mx-auto flex max-w-6xl flex-col justify-between py-2 font-medium text-slate-800 md:flex-row md:items-center">
        ...
        >
          <button
            type="button"
            className="fixed right-4 top-4 mb-4 block p-2 text-3xl text-slate-800 md:hidden"
            aria-expanded={open}
